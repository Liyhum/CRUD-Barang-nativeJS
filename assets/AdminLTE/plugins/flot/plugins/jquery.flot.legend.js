...
(function($) {
    ...
    function getEntryIconHtml(shape) {
        ...
        switch (name) {
            case 'circle':
                html = '<use xlink:href="assets/AdminLTE/#circle" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'diamond':
                html = '<use xlink:href="assets/AdminLTE/#diamond" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'cross':
                html = '<use xlink:href="assets/AdminLTE/#cross" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    // 'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'rectangle':
                html = '<use xlink:href="assets/AdminLTE/#rectangle" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'plus':
                html = '<use xlink:href="assets/AdminLTE/#plus" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    // 'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'bar':
                html = '<use xlink:href="assets/AdminLTE/#bars" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    // 'stroke="' + stroke + '" ' +
                ...
                break;
            case 'area':
                html = '<use xlink:href="assets/AdminLTE/#area" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    // 'stroke="' + stroke + '" ' +
                ...
                break;
            case 'line':
                html = '<use xlink:href="assets/AdminLTE/#line" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    // 'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
