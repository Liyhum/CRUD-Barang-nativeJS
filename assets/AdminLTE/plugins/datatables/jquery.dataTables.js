...
(function( $, window, document, undefined ) {
	 ...
	 * [DataTables.net](href="assets/AdminLTE/http://datatables.net).
	 *
	...
	DataTable.defaults = {
		 ...
		 *           json[i][0] = '<a href="assets/AdminLTE//message/'+json[i][0]+'>View message</a>';
		 *         }
		 *         return json;
		 *       }
		 *     }
	...
	DataTable.defaults.column = {
		 ...
		 *            return '<a href="assets/AdminLTE/'+data+'">Download</a>';
		 *          }
		 *        } ]
		 *      } );
		 *    } );
